...
import com.example.adminfastfood.databinding.ActivityAddPopularMenuItemBinding
import com.google.firebase.database.DatabaseReference
import com.google.firebase.database.FirebaseDatabase

class AddPopularMenuItemActivity : AppCompatActivity() {
    private lateinit var binding: ActivityAddPopularMenuItemBinding
    private lateinit var database: DatabaseReference

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityAddPopularMenuItemBinding.inflate(layoutInflater)
        ...
        binding.buttonPopularAddMenuItem.setOnClickListener {
            ...
            // Save to database
            else saveFoodToDatabase(name, description, price)
    ...
    private fun saveFoodToDatabase(name: String, description: String, price: String) {
        ...
        val foodItem = Food2(name, description, price)
